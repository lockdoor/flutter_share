                          ...
                          children: [
                            ...
                            ListTile(
                                ...
                                title: TextFormField(
                                  ...
                                  onChanged: (value) =>
                                      payByPrincipleDivideAmount(value,
                                          'เงินต้นไม่ถูกต้อง', 'principle'),
                                  onSaved: (value) => shareModel.principle =
                                      int.parse(value.toString()),
                                  validator: (value) =>
                                      checkNum(value, 'จำเป็นต้องใส่เงินต้น'),
                                  decoration:
                                      InputDecoration(labelText: 'เงินต้น'),
                            ...
                            ListTile(
                                leading: Icon(Icons.date_range),
                                title: TextFormField(
                                  onSaved: (value) => shareModel.days =
                                      int.parse(value.toString()),
                                  validator: (String? value) {
                                    String? result;
                                    if (value!.isNotEmpty) {
                                      result = checkNum(
                                          value, 'จำเป็นต้องใส่ระยะส่ง');
                            ...
                            ListTile(
                                ...
                                title: TextFormField(
                                  ...
                                  validator: (value) => checkNum(
                                      value, 'จำเป็นต้องใส่บิดเริ่มต้น'),
                                  decoration:
